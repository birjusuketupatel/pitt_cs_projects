...
public class HeftyInteger {
	 ...
	 */
	  ...
	  */
	 private boolean getBit(int bitPos) throws IllegalArgumentException {
	  ...
	  */
	 private HeftyInteger setBit(int bitPos, boolean bitVal) throws IllegalArgumentException {
		 if(bitPos < 0 || bitPos >= 8 * this.length()) {
			 throw new IllegalArgumentException("target bit out of bounds");
		 }
