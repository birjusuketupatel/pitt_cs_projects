    ...
    while active:
        ...
        match command[0]:
            ...
            case 'l':
                ...
                try:
                    group = conn.root.add_like(message_id)
            ...
            case 'r':
                ...
                try:
                    group_obj = conn.root.remove_like(message_id)
